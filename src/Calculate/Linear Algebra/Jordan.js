            ...
            <div style={{ background: "#FFFF", padding: "30px" }}>
                ...
                <div className="row">
                    <div className="col">
                        <Card
                            bordered={true}
                            style={{ width: 400, background: "#9FE2BF", borderRadius:"15px", color: "#FFFFFF" }}
                        ...
                        >
                            ...
                            {this.state.showDimentionForm &&
                                <div>
                                    ...
                                    <Button id="dimention_button" onClick={
                                        ...
                                        style={{ background: "#f75eb6", color: "white", fontSize: "15px" }}>
                                        Submit<br></br>
                                    </Button>
                                </div>
                            }
                            ...
                            {this.state.showMatrixForm &&
                                <div>
                                    ...
                                    <Button
                                        id="matrix_button"
                                        style={{ background: "#FFBF00", color: "white", fontSize: "15px" }}
                    ...
                    <div className="col">
                        {this.state.showOutputCard &&
                            <Card
                                title={"Output"}
                                bordered={true}
                                style={{ width: 400, background: "#f5a744", color: "#FFFFFF", float: "left" }}
